...
export default function Cereales() {
    const productos = productodata.productos.cereales;
    return (
        <div className="text-black items-center justify-center flex flex-col space-y-4">
            <h1 className="text-2xl font-bold">Cereales</h1>
            <p className="text-lg">Productos Cereales para tu alimentación diaria.</p>
